  ...
  ({ className, type, ...props }, ref) => {
      ...
      return (
        <div className="group relative">
          <input
            ...
            type={type}
            className={cn(
              "flex h-9 w-full rounded-input border border-input bg-card/85 px-3 py-1 text-sm md:text-base",
    ...
    return (
      <input
        ...
        type={type}
        className={cn(
          "flex h-9 w-full rounded-input border border-input bg-card/85 px-3 py-1 text-sm",
          "placeholder:text-muted-foreground/90",
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/40 focus-visible:border-ring/40 transition",
          "disabled:cursor-not-allowed disabled:opacity-50",
          className,
